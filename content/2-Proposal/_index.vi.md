...
- **Xác thực & Tải lên an sau**: Amazon Cognito quản lý tài khoản người dùng an toàn. Amazon S3 cho phép client tải tệp trực tiếp qua Presigned URL để tránh nghẽn luồng xử lý.  
